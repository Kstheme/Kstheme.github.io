---
url: /zh/article/agent-loop-handwritten/index.md
---
...
> 用其他模型也一样，换 base\_url 和 model 名就行。
...
当然它不是生产级的，但它帮你拆掉了 Agent 最神秘的那层窗户纸。下次再有人问"Agent 到底怎么循环的"，你可以说：就是一个 while True，判断 finish\_reason 是不是 tool\_calls。
