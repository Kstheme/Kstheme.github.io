---
url: /article/agent-loop-handwritten/index.md
---
...
> Using other models is the same — just change the base\_url and model name.
...
Of course, it's not production-grade. But it tears down the most mysterious layer of the Agent. Next time someone asks "how does the Agent loop actually work," you can say: it's just a while True checking if finish\_reason is tool\_calls.
